package org.cmjava2023.optimization;
...
public class OptimizationVisitor extends ASTTraverser<ASTNodes.Node> {
    public ArrayList<String> errors;

    public OptimizationVisitor(ArrayList<String> errors) {
        this.errors = errors;
    }
    ...
    public ASTNodes.Node visit(ASTNodes.VariableAssignmentNode node) {
        ...
        Symbol variableSymbol = OptimizationVisitor.resolveNestedIdentifier(null, variableName, node.variable().getScope());
