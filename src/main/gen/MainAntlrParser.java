...
public class MainAntlrParser extends Parser {
	...
	public static final int
		...
		RULE_return_statement = 23, RULE_potentially_nested_identifier = 24, RULE_type = 25, 
		RULE_integral_type = 26, RULE_floating_point_type = 27, RULE_numeric_type = 28, 
		RULE_primitive_type = 29, RULE_reference_type = 30, RULE_class_type = 31, 
		RULE_type_arguments = 32, RULE_type_argument_list = 33, RULE_type_argument = 34, 
		RULE_wildcard = 35, RULE_type_variable = 36, RULE_array_type = 37, RULE_access_modifier = 38;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"potentially_nested_identifier", "type", "integral_type", "floating_point_type", 
			"numeric_type", "primitive_type", "reference_type", "class_type", "type_arguments", 
			"type_argument_list", "type_argument", "wildcard", "type_variable", "array_type", 
			"access_modifier"
		};
	}
	...
	public static class Variable_declarationContext extends ParserRuleContext {
		...
		public Potentially_nested_identifierContext potentially_nested_identifier() {
			return getRuleContext(Potentially_nested_identifierContext.class,0);
		}
	...
	public final Function_declaration_argContext function_declaration_arg() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2117616L) != 0)) {
				{
				{
				setState(182);
				type();
	...
	public final Function_argContext function_arg() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 61572653252608L) != 0)) {
				{
				{
				setState(203);
				expressions();
	...
	@SuppressWarnings("CheckReturnValue")
	public static class Potentially_nested_identifierContext extends ParserRuleContext {
		public List<TerminalNode> IDENTIFIER() { return getTokens(MainAntlrParser.IDENTIFIER); }
		public TerminalNode IDENTIFIER(int i) {
			return getToken(MainAntlrParser.IDENTIFIER, i);
		}
		...
		public Potentially_nested_identifierContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_potentially_nested_identifier; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MainAntlrListener ) ((MainAntlrListener)listener).enterPotentially_nested_identifier(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MainAntlrListener ) ((MainAntlrListener)listener).exitPotentially_nested_identifier(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MainAntlrVisitor ) return ((MainAntlrVisitor<? extends T>)visitor).visitPotentially_nested_identifier(this);
			else return visitor.visitChildren(this);
		}
	}

	public final Potentially_nested_identifierContext potentially_nested_identifier() throws RecognitionException {
		Potentially_nested_identifierContext _localctx = new Potentially_nested_identifierContext(_ctx, getState());
		enterRule(_localctx, 48, RULE_potentially_nested_identifier);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
