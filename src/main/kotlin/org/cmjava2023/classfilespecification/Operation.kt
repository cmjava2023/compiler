...
abstract class Operation(vararg val operands: Any): PlaceHolder {
    ...
    class Goto(jumpOffsetInBytes: Short): Operation(jumpOffsetInBytes)
    class I2b: Operation()
    class I2c: Operation()
    class I2d: Operation()
    class I2f: Operation()
    ...
    class Ifeq(jumpOffsetInBytes: Short): Operation(jumpOffsetInBytes)
    class Ifne(jumpOffsetInBytes: Short): Operation(jumpOffsetInBytes)
    class Iflt(jumpOffsetInBytes: Short): Operation(jumpOffsetInBytes)
    class Ifge(jumpOffsetInBytes: Short): Operation(jumpOffsetInBytes)
    class Ifgt(jumpOffsetInBytes: Short): Operation(jumpOffsetInBytes)
    class Ifle(jumpOffsetInBytes: Short): Operation(jumpOffsetInBytes)
    class If_icmpeq(jumpOffsetInBytes: Short): Operation(jumpOffsetInBytes)
    class If_icmpne(jumpOffsetInBytes: Short): Operation(jumpOffsetInBytes)
    class If_icmplt(jumpOffsetInBytes: Short): Operation(jumpOffsetInBytes)
    class If_icmpge(jumpOffsetInBytes: Short): Operation(jumpOffsetInBytes)
    class If_icmpgt(jumpOffsetInBytes: Short): Operation(jumpOffsetInBytes)
    class If_icmple(jumpOffsetInBytes: Short): Operation(jumpOffsetInBytes)
