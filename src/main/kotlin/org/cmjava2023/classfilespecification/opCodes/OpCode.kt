...
abstract class OpCode(vararg val values: Any): OpCodeOrPlaceHolder {
    ...
    class Dneg: OpCode()
    class Drem: OpCode()
    class Dreturn: OpCode(), ReturningOpCode
    ...
    class Fneg: OpCode()
    class Frem: OpCode()
    class Freturn: OpCode(), ReturningOpCode
    ...
    class Lor: OpCode()
    class Lrem: OpCode()
    class Lreturn: OpCode(), ReturningOpCode
    class Lshl: OpCode()
    class Lshr: OpCode()
    ...
    class Pop2: OpCode()
    class Pop: OpCode()
    class Return: OpCode(), ReturningOpCode
    class Saload: OpCode()
