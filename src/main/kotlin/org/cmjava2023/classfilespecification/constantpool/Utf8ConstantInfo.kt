...
class Utf8ConstantInfo(val content: String): ConstantInfo(ConstantInfoTag.CONSTANT_Utf8) {
    private val utf8encodedName: String = String(content.toByteArray(), Charsets.UTF_8)
