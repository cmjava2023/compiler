...
class StringConcatPlaceHoldersLeavingKnownTypeOnStackQuery {
    companion object {
        fun fetch(placeHoldersToLoadLeftString: List<PlaceHolder>, rightExpressionType: BuiltInType): PlaceHoldersLeavingKnownTypeOnStack {
            ...
            result += Operation.Invokevirtual(ConstantPoolEntry.MethodReferenceConstant.stringBuilderAppendFor(TypeDescriptor.forBuildInType(rightExpressionType)))
