...
class BinaryOperatorUsagePlaceHoldersLeavingKnownTypeOnStackQuery(
    private val astTraverserToGetPlaceHoldersLeavingKnownTypeOnStack: AstTraverserToGetPlaceHoldersLeavingKnownTypeOnStack,
    ...
    fun fetch(
        ...
        return when {
            leftType == BuiltInType.STRING && rightType is BuiltInType && binaryOperator == MathOperator.PLUS -> StringConcatPlaceHoldersLeavingKnownTypeOnStackQuery.fetch(
                constantPoolBuilder,
                astTraverserToGetPlaceHoldersLeavingKnownTypeOnStack.dispatch(leftExpression).placeHolders,
                astTraverserToGetPlaceHoldersLeavingKnownTypeOnStack.dispatch(rightExpression).placeHolders,
                rightType
            )
